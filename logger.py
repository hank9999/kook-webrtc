...
# https://github.com/jimdragongod/mediasoup-client-pysdk/blob/main/smcdk/log/logger.py
...
class Logger:
    @staticmethod
    def get_logger(module_name: str, level=logging.WARNING, enable_console=True, log_file_path=None):
        """
